      ...
      <Box>
        <FormContainer isSuccess>
          <Stack justifyContent={'center'} alignItems={'center'} gap={2}>
            <Avatar sx={{ width: 82, height: 82, bgcolor: 'white' }} variant='rounded'>
              <Icon icon={'fluent:checkmark-28-filled'} width={68} style={{ color: theme.palette.success.main }} />
            </Avatar>
            <Typography variant='h3' mt={6}>
              Your request has been submitted successfully..
            </Typography>
            <Typography mb={6}>We will reach you out to confirm your order.</Typography>
